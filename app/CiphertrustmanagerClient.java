...
// 	public static final Map<String, String> keyLabelsToAdd = ImmutableMap.of("created_by_yugabyte", "true");
...
// 	public CiphertrustManagerClient(String baseUrl, AuthType authType, String refreshToken, String username,
// 			String password, KeyStore ybaAndJavaKeyStore, String keyName, String keyAlgorithm, int keySize) {
...
// 		return String.format("URI: %s%nStatus Code: %d%nResponse Body:%n%s", response.uri(), response.statusCode(),
// 				response.body());
// 	}
...
// 					.header("Content-Type", "application/json").header("Authorization", "Bearer " + this.jwt).GET()
// 					.build();
...
// 				return null;
// 			} else {
// 				log.error("CipherTrust GET request was not successful. Response: " + formatHttpResponse(response));
// 				throw new PlatformServiceException(INTERNAL_SERVER_ERROR,
// 						"CipherTrust GET request was not successful.");
// 			}
// 		} catch (Exception e) {
...
// 	public Map<String, Object> sendPostHttpRequestAndGetBody(String apiUrl, Map<String, Object> requestBodyMap,
// 			boolean withJwt) {
// 		Map<String, Object> responseBody = new HashMap<>();
// 		try {
// 			// Convert the map to a JSON string
...
// 			HttpRequest request;
// 			if (withJwt) {
// 				request = HttpRequest.newBuilder().uri(URI.create(apiUrl)).header("Content-Type", "application/json")
// 						.header("Accept", "application/json").header("Authorization", "Bearer " + this.jwt)
...
// 				return responseBody;
// 			} else {
// 				log.error("CipherTrust POST request was not successful. Response: " + formatHttpResponse(response));
// 				throw new PlatformServiceException(INTERNAL_SERVER_ERROR,
// 						"CipherTrust POST request was not successful.");
// 			}
// 		} catch (Exception e) {
// 			throw new RuntimeException(e);
// 		}
...
// 			} else {
// 				// We don't specify the grant_type for password authentication as it is the
// 				// default.
...
// 			Map<String, Object> responseBody = sendPostHttpRequestAndGetBody(apiUrl, requestBodyMap, false);
...
// 				throw new PlatformServiceException(INTERNAL_SERVER_ERROR, "No JWT present in response body.");
// 			}
// 		} catch (Exception e) {
// 			throw new RuntimeException(e);
// 		}
...
// 			// Send the request and get the response body
// 			Map<String, Object> responseBody = sendPostHttpRequestAndGetBody(apiUrl, requestBodyMap, true);
...
// 				throw new PlatformServiceException(INTERNAL_SERVER_ERROR,
// 						"Create key response body does not contain key name.");
// 			}
// 		} catch (Exception e) {
// 			throw new RuntimeException(e);
// 		}
...
// 				throw new PlatformServiceException(INTERNAL_SERVER_ERROR, "Encrypt text response body is empty.");
// 			}
// 		} catch (Exception e) {
// 			throw new RuntimeException(e);
// 		}
...
// 				throw new PlatformServiceException(INTERNAL_SERVER_ERROR,
// 						"Decrypt text response body does not contain plaintext.");
// 			}
// 		} catch (Exception e) {
// 			throw new RuntimeException(e);
// 		}
